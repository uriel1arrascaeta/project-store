...
function eliminarDelCarrito (e){
    ...
    Toastify({
        ...
        style: {
          background: "linear-gradient(to right, #808080, #afafaf)",
        },
        offset: {
...
function actualizarTotal(){
    const totalCalculdo = productosEnCarrito.reduce((acc,producto) => acc + (producto.precio * producto.cantidad), 0);
    total.innerText = `$${totalCalculdo}`;
}
